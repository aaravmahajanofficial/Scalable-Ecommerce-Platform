...
func MustLoad() *Config {
	...
	// #nosec G703 -- config path is provided via env var or CLI flag for app initialization
...
func LoadConfigFromPath(configPath string) (*Config, error) {
	...
	// #nosec G703 -- config path is provided via parameter for app initialization
	if _, err := os.Stat(filepath.Clean(configPath)); os.IsNotExist(err) {
